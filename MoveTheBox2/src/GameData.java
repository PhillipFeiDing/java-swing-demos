...
public class GameData {
    ...
    public boolean ifShowBoardWins() {return showBoard.isWin();}

    public void swapShowBoard(int x1, int y1, int x2, int y2) { showBoard.swap(x1, y1, x2, y2); }

    public void dropShowBoard()  {showBoard.drop();}

    public boolean matchShowBoard() {return showBoard.match();}
}
