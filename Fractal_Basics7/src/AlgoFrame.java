...
public class AlgoFrame extends JFrame{
    ...
    private class AlgoCanvas extends JPanel{
        ...
        private void drawFractal(Graphics2D g, double x1, double y1, double side, double angle, int depth) {
            ...
            double side_2 = side * (data.getSplitPosition());
            AlgoVisHelper.setStrokeWidth(g, Math.max(data.getDepth() - depth + 1, 1));
            ...
            drawFractal(g, x2, y2, side - side_2, angle + data.getSplitAngle() / 2, depth + 1);
            drawFractal(g, x2, y2, side - side_2, angle - data.getSplitAngle() / 2, depth + 1);
