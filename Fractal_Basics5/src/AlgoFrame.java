...
public class AlgoFrame extends JFrame{
    ...
    private class AlgoCanvas extends JPanel{
        ...
        public void paintComponent(Graphics g) {
            ...
            // 具体绘制
            int initialSide = canvasWidth;

            double x1 = 0; double y1 = initialSide / 3 * Math.sin(60 / 180.0 * Math.PI);
            drawFractal(g2d, x1, y1, canvasWidth,0, 0);

            double x2 = x1 + initialSide / 2; double y2 = y1 + initialSide * Math.sin(60 / 180.0 * Math.PI);
            drawFractal(g2d, x2, y2, canvasWidth,120, 0);

            double x3 = x1 + initialSide; double y3 = y1;
            drawFractal(g2d, x3, y3, canvasWidth,-120, 0);
        }
